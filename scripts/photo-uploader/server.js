/*
Simple uploader server (no dependencies).
- Serves a static HTML form at http://localhost:3001/
- Accepts POST /create with JSON body to create an MDX file in ../src/content/photo

Usage:
  node server.js

Security: This is a local helper script. Do not expose to the public internet.
*/
...
/* mdxTemplate is defined above (the improved version). */
